...
import ChannelScanDialog from "./_components/channel-scan-dialog";
  ...
  return (
    <div className="pt-16 flex-1 p-4 md:max-w-6xl md:mx-auto h-[calc(100vh-62px)] overflow-y-auto">
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2">
        <div className="px-4 py-8 border border-dashed rounded-md flex justify-center items-center">
          <div className="flex flex-col items-center text-center">
            <h2 className="font-medium text-xl">Single video</h2>
            <p className="mb-4 text-sm text-muted-foreground max-w-xs">
              Deep-dive one video: labels, insights, reply drafts, niche
              benchmark.
            </p>
            <CreateProjectDialog />
          </div>
        ...
        <div className="px-4 py-8 border border-dashed rounded-md flex justify-center items-center">
          <div className="flex flex-col items-center text-center">
            <h2 className="font-medium text-xl">Channel trends</h2>
            <p className="mb-4 text-sm text-muted-foreground max-w-xs">
              Compare sentiment across the last N uploads. Trends over time,
              not just one demo video.
            </p>
            <ChannelScanDialog />
          </div>
        </div>
      ...
      <div className="mt-8 pb-12">
        <h2 className="text-xl">Recent video projects</h2>
